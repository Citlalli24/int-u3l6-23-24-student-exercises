...
//  - The event type is mouseover
    ...
    hoverCard.addEventListener('mouseover', function(event) {
...
//  - The event type is mouseout
    ...
    hoverCard.addEventListener('mouseout', function(event) {
    let image = document.querySelector('.hidden-image');
    image.style.width = '0';
...
//  - The event type is dblclick
    ...
    doubleClickCard.addEventListener('dblclick', function(event) {
